...
curl -sS https://raw.githubusercontent.com/unli150/v1/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/unli150/v1/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/unli150/v1/main/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/unli150/v1/main/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/unli150/v1/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O auto-reboot "https://raw.githubusercontent.com/unli150/v1/main/menu/auto-reboot.sh"
wget -O restarts "https://raw.githubusercontent.com/unli150/v1/main/menu/restarts.sh"
wget -O bw "https://raw.githubusercontent.com/unli150/v1/main/menu/bw.sh"
